...
function Consent() {
  ...
  async function decide(approve: boolean) {
    ...
    if (!target) {
      setBusy(false);
      setError("لم تُرجع خدمة المصادقة رابط العودة.");
      return;
    }
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-secondary/40 px-4 py-8">
      <div className="w-full max-w-md rounded-2xl border bg-card p-6 text-center shadow-sm">
        <img src={platformLogo.url} alt="شعار منصة الذات" className="mx-auto size-20 object-contain" />
        <h1 className="mt-4 text-xl font-bold">ربط {clientName} بحسابك</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          سيتمكن {clientName} من قراءة سجلاتك في منصة الذات وإضافة حالات ومقابلات نيابة عنك.
        </p>
        {error && (
