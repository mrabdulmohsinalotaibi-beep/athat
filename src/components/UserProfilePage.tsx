...
export function UserProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6" dir="rtl">
      <section className="overflow-hidden rounded-[2rem] border border-primary/15 bg-gradient-to-l from-primary via-primary/95 to-primary/75 p-6 text-primary-foreground shadow-xl shadow-primary/15 sm:p-8">
