...
// الثوابت والخيارات المحددة مسبقاً
...
export const EXEC_STATUS = ["لم يبدأ", "قيد التنفيذ", "مكتمل", "مؤجل"] as const;
export const DOC_STATUS = ["ناقص", "قيد المراجعة", "معتمد"] as const;
export const CHANNELS = ["مقابلة", "اتصال هاتفي", "رسالة نصية", "واتساب", "بريد إلكتروني", "زيارة منزلية"] as const;
export const EVIDENCE_TYPES = ["PDF", "صورة", "تقرير", "كشف حضور", "محضر"] as const;
export const PROGRAM_TYPES = ["وقائي", "إنمائي", "علاجي"] as const;
export const REFERRAL_SOURCES = ["الطالب نفسه", "ولي الأمر", "المعلم", "إدارة المدرسة", "لجنة التوجيه الطلابي", "ملاحظة الموجه"] as const;
export const REFERRAL_REASONS = ["صعوبات أكاديمية", "غياب أو تأخر متكرر", "مشكلة سلوكية", "مشكلة نفسية", "مشكلة اجتماعية أو أسرية", "مشكلة صحية", "حماية من الإيذاء", "احتياج تربوي خاص"] as const;
export const INTERNAL_REFERRAL_DESTINATIONS = ["إدارة المدرسة", "وكيل شؤون الطلاب", "لجنة التوجيه الطلابي", "المعلم", "المرشد الصحي"] as const;
export const EXTERNAL_REFERRAL_DESTINATIONS = ["وحدة الخدمات الإرشادية", "وحدة الرعاية الطلابية", "إدارة التعليم", "المركز الصحي", "جهة صحية", "جهة أمنية", "جهة مختصة"] as const;
export const REFERRAL_DESTINATIONS = [...INTERNAL_REFERRAL_DESTINATIONS, ...EXTERNAL_REFERRAL_DESTINATIONS];
export const INTERVENTIONS = ["مقابلة فردية", "جلسة إرشاد جمعي", "تواصل مع ولي الأمر", "خطة تعديل سلوك", "متابعة أكاديمية", "إحالة لجهة مختصة", "تنسيق مع المعلمين", "متابعة دورية"] as const;
